...
let sumAndProduct = (a, b) => `${a} + ${b} = ${a + b}, ${a} * ${b} = ${a*b}`;
...
//"this" is undefined because it has no reference. JS is trying to pull a "this" reference globally where there is none.
// 2. What is "this" when joe.scopeArrow() is invoked?
//"this" is undefined because once again it has no reference.
// 3. Explain why "this" is different when an arrow function is used.
//"this" is different when an arrow function is used because it changes the scope of that declration from local to global. When that is done there is no reference for "this" anymore and yeilds an undefined variable.
